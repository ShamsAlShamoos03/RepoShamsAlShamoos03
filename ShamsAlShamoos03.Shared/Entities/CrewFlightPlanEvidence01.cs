...
using System.Threading.Tasks;
    ...
    public class CrewFlightPlanEvidence01
    {
         [Key]
        ...
        ////public string? MelliCode { get; set; }
        ////[ForeignKey("MelliCode")]
        ////public virtual TblMaster oo_CrewFlightPlanEvidence01 { get; set; }
        ...
        //[ForeignKey("StatusCrewFlightPlanEvidence01")]
        //public virtual CategoryGeneral oo_StatusCrewFlightPlanEvidence01 { get; set; }
...
public bool? IsHaveJob { get; set; }
        ...
        public string? DateHealthEvidence01ID
        {
            ...
            get
            {
                ...
                //RADARDFstr =
                //                            (item.oo_FlightPlanEvidence01ID.RADARDF == null) ? "" :
                //                            (item.oo_FlightPlanEvidence01ID.RADARDF != null) ? item.oo_FlightPlanEvidence01ID.oo_RADARDF.Title : null,

                //return this.oo_HealthEvidence01.ToDateHealthEvidenceTitle;
                //return this.oo_CrewFlightPesronel.oodr;
                //return this.oo_CrewFlightPesronel.ooDRJCOD.Title + " " + this.oo_CrewFlightPesronel.FST_NAM + " " + this.oo_CrewFlightPesronel.LST_NAM + " " + this.oo_CrewFlightPesronel.ooRateFlight.Rate_CategoryGeneral.Title + " " + this.oo_CrewFlightPesronel.oo_PhoneEvidence01.Phone01;
                //return this.oo_CrewFlightPesronel.ooDRJCOD.Title + " " + this.oo_CrewFlightPesronel.FST_NAM + " " + this.oo_CrewFlightPesronel.LST_NAM + " " + this.oo_CrewFlightPesronel.ooRateFlight.Rate_CategoryGeneral.Title + " " + this.oo_CrewFlightPesronel.oo_PhoneEvidence01.Phone01;
                //return (this.MelliCode == null) ? "" :
                // (this.MelliCode != null) ? this.oo_CrewFlightPesronel.ooDRJCOD.Title + " " + this.oo_CrewFlightPesronel.FST_NAM + " " + this.oo_CrewFlightPesronel.LST_NAM + " " + this.oo_CrewFlightPesronel.ooRateFlight.Rate_CategoryGeneral.Title + " " + this.oo_CrewFlightPesronel.oo_PhoneEvidence01.Phone01
                //: null;
                //return this.oo_CrewFlightPesronel.MelliCode == null ? "" : this.oo_CrewFlightPesronel.MelliCode;
                //return this.oo_FlightPlanEvidence01ID.oo_FlightActivityEvidence01ID.FromDateFlightActivityEvidence01Title == null ? "" : this.oo_FlightPlanEvidence01ID.oo_FlightActivityEvidence01ID.FromDateFlightActivityEvidence01Title;
                //return this.oo_FlightPlanEvidence01ID.RADARDF == null ? "" : /* return something else */;
                ...
                //return this.MelliCode == null ? "33" : this.MelliCode != null ? this.oo_CrewFlightPesronel.FST_NAM.ToString() : null/* return something else */;
                //return this.MelliCode


                //return this.oo_CrewFlightPesronel.Include(u => u.Address).FirstOrDefault(u => u.Id == 1);


                //return this.oo_CrewFlightPesronel..Where(b => b.Name == "ADO.NET Blog")
                //   .Include(b => b.Posts)
                //   .FirstOrDefault();
