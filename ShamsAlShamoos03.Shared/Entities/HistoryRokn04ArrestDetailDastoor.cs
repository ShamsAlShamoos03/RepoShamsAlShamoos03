...
public class HistoryRokn04ArrestDetailDastoor01
{
    /// <summary>
    ///  تاریخ شمسی
    /// </summary>
    [Key]
    //[StringLength(10, MinimumLength = 10, ErrorMessage = "HistoryRokn04ArrestDetailDastoor01ID must be 8 characters")]
    public string? HistoryRokn04ArrestDetailDastoor01ID { get; set; }

    public string? HistoryRokn04ArrestDastoor01ID { get; set; }
    [ForeignKey("HistoryRokn04ArrestDastoor01ID")]
    public virtual HistoryRokn04ArrestDastoor01 oo_HistoryRokn04ArrestDastoor { get; set; }
