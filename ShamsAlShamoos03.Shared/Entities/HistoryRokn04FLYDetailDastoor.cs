...
using System.ComponentModel.DataAnnotations.Schema;
    ...
    public class HistoryRokn04FLYDetailDastoor01
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
        [Key]
        //[StringLength(10, MinimumLength = 10, ErrorMessage = "HistoryRokn04FLYDetailDastoor01ID must be 8 characters")]
        public string? HistoryRokn04FLYDetailDastoor01ID { get; set; }

        public string? HistoryRokn04FLYDastoor01ID { get; set; }
        [ForeignKey("HistoryRokn04FLYDastoor01ID")]
        public virtual HistoryRokn04FLYDastoor01 oo_HistoryRokn04FLYDastoor { get; set; }
