...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryRokn04ArrestDastoor01_Tbl])
)
...
--top 1
	...
	LEFT(pc.[DocumentNO01],10)   AS Date01 ,
	  ...
	  --[CatDateProperty01].HolidayStatusArrestID as HolidayStatusArrestID,
...
FROM [dbo].[HistoryRokn04ArrestDastoor01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryRokn04ArrestDastoor01ID = dc.HistoryRokn04ArrestDastoor01ID
