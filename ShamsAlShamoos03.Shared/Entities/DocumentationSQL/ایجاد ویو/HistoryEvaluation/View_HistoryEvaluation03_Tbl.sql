...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryEvaluation01_Tbl])
)

SELECT 
--top 1
    pc.[HistoryEvaluation01ID],
     pc.[MelliCode],
      pc.TypeLetter01,
     pc.DocumentNO01,
    pc.strTextContent01,
...
FROM [dbo].[HistoryEvaluation01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryEvaluation01ID = dc.HistoryEvaluation01ID
