...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryRokn04jamDastoor01_Tbl])
)
...
FROM [dbo].[HistoryRokn04jamDastoor01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryRokn04jamDastoor01ID = dc.HistoryRokn04jamDastoor01ID
