...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryReduceWorkPersonal01_Tbl])
)

SELECT 
--top 1
    pc.[HistoryReduceWorkPersonal01ID],
     pc.[MelliCode],
      pc.TypeLetter01,
     pc.DocumentNO01,
    pc.strTextContent01,
...
FROM [dbo].[HistoryReduceWorkPersonal01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryReduceWorkPersonal01ID = dc.HistoryReduceWorkPersonal01ID
