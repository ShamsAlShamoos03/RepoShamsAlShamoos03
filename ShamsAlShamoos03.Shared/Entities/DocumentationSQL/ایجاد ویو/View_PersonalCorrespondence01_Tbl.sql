   ...
   SELECT   
      ...
      ,[StatusConfirmation02]
	  			...
	  			,[strVariabl02]
				,[PersonalCorrespondence01_Tbl].Vartext02 AS strCatstrVariabl02
			--, CatstrVariabl02.Title   AS strCatstrVariabl02
			,[PersonalCorrespondence01_Tbl].Vartext01
 						  ,  CASE 
        WHEN [StatusConfirmation01] = 320 AND [StatusConfirmation02] = 320 AND [TypeLetter01] = 636
        THEN 
            CASE 
                WHEN PATINDEX('%[0-9]%', [PersonalCorrespondence01_Tbl].Vartext02) > 0
                THEN CAST(
                    SUBSTRING(
                        [PersonalCorrespondence01_Tbl].Vartext02,
                        PATINDEX('%[0-9]%', [PersonalCorrespondence01_Tbl].Vartext02),
                        PATINDEX('%[^0-9]%', 
                            SUBSTRING([PersonalCorrespondence01_Tbl].Vartext02, 
                                     PATINDEX('%[0-9]%', [PersonalCorrespondence01_Tbl].Vartext02), 
                                     20) + ' ') - 1
                    ) AS INT
                )
	...
	,CASE 
    WHEN [StatusConfirmation01] = 320 AND [StatusConfirmation02] = 320 AND [TypeLetter01] = 767
    THEN 
        CASE 
            WHEN PATINDEX('%[-][0-9]%', [PersonalCorrespondence01_Tbl].Vartext01) > 0 OR PATINDEX('%[0-9]%', [PersonalCorrespondence01_Tbl].Vartext01) > 0
            THEN 
                CAST(
                    SUBSTRING(
                        [PersonalCorrespondence01_Tbl].Vartext01,
                        -- شروع از عدد منفی یا مثبت
                        CASE 
                            WHEN PATINDEX('%[-][0-9]%', [PersonalCorrespondence01_Tbl].Vartext01) > 0 THEN PATINDEX('%[-][0-9]%', [PersonalCorrespondence01_Tbl].Vartext01)
                            ELSE PATINDEX('%[0-9]%', [PersonalCorrespondence01_Tbl].Vartext01)
                        END,
                        -- طول عدد: شامل - هم باید باشد، پس نباید [^0-9] استفاده کنیم
                        -- بنابراین از PATINDEX('%[^0-9]%', ...) استفاده نمی‌کنیم
                        -- از CHARINDEX برای پیدا کردن اولین space یا پایان رشته استفاده می‌کنیم
                        CHARINDEX(' ', 
                            SUBSTRING(
                                [PersonalCorrespondence01_Tbl].Vartext01,
                                CASE 
        ...
        END
    ELSE NULL
END AS TotalVacationDaysCount01
...
--    THEN 
--        CASE 
--            WHEN PATINDEX('%[-0-9]%', Vartext01) > 0
--            THEN 
--                CAST(
--                    SUBSTRING(
--                        Vartext01,
--                        PATINDEX('%[-0-9]%', Vartext01),
--                        PATINDEX('%[^0-9]%', 
--                            SUBSTRING(Vartext01, 
--                                PATINDEX('%[-0-9]%', Vartext01), 
--                                20
...
--END AS TotalVacationDaysCount01
    ...
    --END AS LeaveDays
	        ...
	        ,TypeLetter01	 
			         ...
			         --  , CASE 
            --    WHEN TypeLetter01 IN (632)   and [DrjSubLookupId] Not IN (7,8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1', N'نظامی'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, CASE WHEN DateDesAmar02 IS NULL THEN 0 ELSE dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) END)), 'a4', CONVERT(NVARCHAR, ISNULL(CONVERT(NVARCHAR, luDesAmar01.[Title]), '')))
            --    WHEN TypeLetter01 IN (633)  and [DrjSubLookupId] Not IN (7,8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1', N'نظامی'), 'a2', CONVERT(NVARCHAR, ISNULL(DateDesAmar01, ''))), 'a3', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])))), 'a4', CONVERT(NVARCHAR, ISNULL(luDesAmar01.[Title], ''))), 'a5', CONVERT(NVARCHAR, DateDesAmar02)), 'a6', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) - (SELECT COUNT(TimwStartEnd01) FROM [NewsDB].[dbo].[DateProperty01_Tbl] WHERE TimwStartEnd01 = 625 AND DateProperty01ID >= DateDesAmar01 AND DateProperty01ID < DateDesAmar02)))
            --    WHEN TypeLetter01 IN (634)
            --    THEN REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1', N'نظامی'), 'a2', CONVERT(NVARCHAR, DateDesAmar01))
            --    WHEN TypeLetter01 IN (635) and [DrjSubLookupId] Not IN (7,8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1', N'نظامی'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, [DateDesAmar02])), 'a4', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02]))))
                
            --    WHEN TypeLetter01 IN (632)   and [DrjSubLookupId]  IN (8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1',  N'وظیفه'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, CASE WHEN DateDesAmar02 IS NULL THEN 0 ELSE dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) END)), 'a4', CONVERT(NVARCHAR, ISNULL(CONVERT(NVARCHAR, luDesAmar01.[Title]), '')))
            --    WHEN TypeLetter01 IN (633)  and [DrjSubLookupId]  IN (8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1',  N'وظیفه'), 'a2', CONVERT(NVARCHAR, ISNULL(DateDesAmar01, ''))), 'a3', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])))), 'a4', CONVERT(NVARCHAR, ISNULL(luDesAmar01.[Title], ''))), 'a5', CONVERT(NVARCHAR, DateDesAmar02)), 'a6', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) - (SELECT COUNT(TimwStartEnd01) FROM [NewsDB].[dbo].[DateProperty01_Tbl] WHERE TimwStartEnd01 = 625 AND DateProperty01ID >= DateDesAmar01 AND DateProperty01ID < DateDesAmar02)))
            --    WHEN TypeLetter01 IN (634)
            --    THEN REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1',  N'وظیفه'), 'a2', CONVERT(NVARCHAR, DateDesAmar01))
            --    WHEN TypeLetter01 IN (635) and [DrjSubLookupId]  IN (8,10,12,13) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1',  N'وظیفه'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, [DateDesAmar02])), 'a4', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02]))))
                
                
            --    WHEN TypeLetter01 IN (632)   and [DrjSubLookupId]  IN (7) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1',  N'کارمند'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, CASE WHEN DateDesAmar02 IS NULL THEN 0 ELSE dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) END)), 'a4', CONVERT(NVARCHAR, ISNULL(CONVERT(NVARCHAR, luDesAmar01.[Title]), '')))
            --    WHEN TypeLetter01 IN (633)  and [DrjSubLookupId]  IN (7) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(ISNULL(Cattypeltter01.CategoryDescription, ''), 'a1',  N'کارمند'), 'a2', CONVERT(NVARCHAR, ISNULL(DateDesAmar01, ''))), 'a3', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])))), 'a4', CONVERT(NVARCHAR, ISNULL(luDesAmar01.[Title], ''))), 'a5', CONVERT(NVARCHAR, DateDesAmar02)), 'a6', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02])) - (SELECT COUNT(TimwStartEnd01) FROM [NewsDB].[dbo].[DateProperty01_Tbl] WHERE TimwStartEnd01 = 625 AND DateProperty01ID >= DateDesAmar01 AND DateProperty01ID < DateDesAmar02)))
            --    WHEN TypeLetter01 IN (634)
            --    THEN REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1',  N'کارمند'), 'a2', CONVERT(NVARCHAR, DateDesAmar01))
            --    WHEN TypeLetter01 IN (635) and [DrjSubLookupId]  IN (7) 
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1',  N'کارمند'), 'a2', CONVERT(NVARCHAR, DateDesAmar01)), 'a3', CONVERT(NVARCHAR, [DateDesAmar02])), 'a4', CONVERT(NVARCHAR, dbo.CalculateDaysDifference1(dbo.[ShamsiToMiladi]([DateDesAmar01]), dbo.[ShamsiToMiladi]([DateDesAmar02]))))
                
                                
            --    WHEN DailyPlanEvidence01ID IS NULL
            --    THEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(Cattypeltter01.CategoryDescription, 'a1', N'نظامی'), 'a2', ISNULL(CONVERT(NVARCHAR, lustrVariabl01.Title), '')), 'a3', ISNULL(CONVERT(NVARCHAR, lustrVariabl02.Title), '')), 'a4', ISNULL(CONVERT(NVARCHAR, lustrVariabl03.Title), '')), 'a5', ISNULL(CONVERT(NVARCHAR, lustrVariabl04.Title), '')), 'a6', ISNULL(CONVERT(NVARCHAR, lustrVariabl05.Title), '')), 'a7', ISNULL(CONVERT(NVARCHAR, lustrVariabl06.Title), '')), 'd1', ISNULL(CONVERT(NVARCHAR, VarDate01), '')), 'd2', ISNULL(CONVERT(NVARCHAR, VarDate02), '')), 'd3', ISNULL(CONVERT(NVARCHAR, VarDate04), '')), 'd1', ISNULL(CONVERT(NVARCHAR, VarDate04), '')), 'd5', ISNULL(CONVERT(NVARCHAR, VarDate05), '')), 'd6', ISNULL(CONVERT(NVARCHAR, VarDate06), ''))
            --    ELSE NULL
			...
			, Cattypeltter01.CategoryDescription   AS strDesTypeLetter01
			,[strVariabl01]
