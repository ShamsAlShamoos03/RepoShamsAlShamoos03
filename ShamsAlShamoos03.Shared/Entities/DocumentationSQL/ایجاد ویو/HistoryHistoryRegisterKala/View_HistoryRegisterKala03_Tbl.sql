...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryRegisterKala01_Tbl])
)

SELECT 
--top 1
    pc.[HistoryRegisterKala01ID],
     pc.[MelliCode],
      pc.TypeLetter01,
     pc.DocumentNO01,
    pc.strTextContent01,
...
FROM [dbo].[HistoryRegisterKala01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryRegisterKala01ID = dc.HistoryRegisterKala01ID
