...
/****** Object:  View [dbo].[View_PersonalCorrespondence03_Tbl]    Script Date: 6/17/2025 2:32:25 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[View_PersonalCorrespondence04_Tbl]
AS
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_PersonalCorrespondence03_Tbl'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_PersonalCorrespondence03_Tbl'
GO
