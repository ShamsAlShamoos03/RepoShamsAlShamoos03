SELECT 
     ...
     DailyActivityEvidence01_Tbl.[StateName01],
     CatStateName.Title AS StateName01str,
   
      DailyActivityEvidence01_Tbl.[NOTAMCHECKETitle01],
	...
	Sortable01_Tbl.Description as SortableTitle01, 
	  DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],
	DailyActivityEvidence01_Tbl.IsHaveJob,

		    REPLACE(DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],'-', '''') AS DailyActivityEvidence01IDstr ,
            REPLACE(DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],'-', '3') AS DailyActivityEvidence01IDstr3 ,
            REPLACE(DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],'-', '4') AS DailyActivityEvidence01IDstr4 ,
            REPLACE(DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],'-', '5') AS DailyActivityEvidence01IDstr5 ,
            REPLACE(DailyActivityEvidence01_Tbl.[DailyActivityEvidence01ID],'-', '6') AS DailyActivityEvidence01IDstr6 ,

	DailyActivityEvidence01_Tbl.Sortable01Id,
		            CASE 
                WHEN DailyActivityEvidence01_Tbl.[IsHaveJob] IN (0) THEN COALESCE( N'غیر فعال', '''')
                WHEN DailyActivityEvidence01_Tbl.[IsHaveJob] IN (1) THEN COALESCE( N'فعال', '''')
                ELSE '0'
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation01,
    luStatusConfirma01.Title AS [StatusConfirmation01str],
    DailyActivityEvidence01_Tbl.UjobPesronel01,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation02,
    luStatusConfirma02.Title AS [StatusConfirmation02str],
    DailyActivityEvidence01_Tbl.UjobPesronel02,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation03,
    luStatusConfirma03.Title AS [StatusConfirmation03str],
    DailyActivityEvidence01_Tbl.UjobPesronel03,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation04,
    luStatusConfirma04.Title AS [StatusConfirmation04str],
    DailyActivityEvidence01_Tbl.UjobPesronel04,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation05,
    luStatusConfirma05.Title AS [StatusConfirmation05str],
    DailyActivityEvidence01_Tbl.UjobPesronel05,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation06,
    luStatusConfirma06.Title AS [StatusConfirmation06str],
    DailyActivityEvidence01_Tbl.UjobPesronel06,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation07,
    luStatusConfirma07.Title AS [StatusConfirmation07str],
    DailyActivityEvidence01_Tbl.UjobPesronel07,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation08,
    luStatusConfirma08.Title AS [StatusConfirmation08str],
    DailyActivityEvidence01_Tbl.UjobPesronel08,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation09,
    luStatusConfirma09.Title AS [StatusConfirmation09str],
    DailyActivityEvidence01_Tbl.UjobPesronel09,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation10,
    luStatusConfirma10.Title AS [StatusConfirmation10str],
    DailyActivityEvidence01_Tbl.UjobPesronel10,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation11,
    luStatusConfirma11.Title AS [StatusConfirmation11str],
    DailyActivityEvidence01_Tbl.UjobPesronel11,
    ...
    DailyActivityEvidence01_Tbl.StatusConfirmation12,
    luStatusConfirma12.Title AS [StatusConfirmation12str],
    DailyActivityEvidence01_Tbl.UjobPesronel12,
	...
	FROM 
	    [NewsDB].[dbo].[DailyActivityEvidence01_Tbl]
INNER JOIN 
    dbo.View_DateProperty01_Tbl AS CatDateProperty01
    ON CatDateProperty01.DateProperty01ID = [DailyActivityEvidence01_Tbl].FromDateDailyActivityEvidence01Title

	INNER JOIN 
    dbo.View_CategoriesGeneral_Tbl AS CatStateName 
    ON CatStateName.CategoryGeneralId=[DailyActivityEvidence01_Tbl].StateName01 

	   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma01
    ON luStatusConfirma01.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation01  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma02
    ON luStatusConfirma02.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation02  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma03
    ON luStatusConfirma03.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation03  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma04
    ON luStatusConfirma04.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation04  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma05
    ON luStatusConfirma05.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation05  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma06
    ON luStatusConfirma06.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation06  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma07
    ON luStatusConfirma07.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation07  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma08
    ON luStatusConfirma08.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation08  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma09
    ON luStatusConfirma09.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation09  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma10
    ON luStatusConfirma10.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation10  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma11
    ON luStatusConfirma11.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation11  	

   	LEFT OUTER JOIN
    dbo.View_CategoriesGeneral_Tbl AS luStatusConfirma12
    ON luStatusConfirma12.CategoryGeneralId=DailyActivityEvidence01_Tbl.StatusConfirmation12  	

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel01_Tbl 
    ON View_UjobPesronel01_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel01
	
	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel02_Tbl 
    ON View_UjobPesronel02_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel02

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel03_Tbl 
    ON View_UjobPesronel03_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel03

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel04_Tbl 
    ON View_UjobPesronel04_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel04

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel05_Tbl 
    ON View_UjobPesronel05_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel05

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel06_Tbl 
    ON View_UjobPesronel06_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel06

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel07_Tbl 
    ON View_UjobPesronel07_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel07

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel08_Tbl 
    ON View_UjobPesronel08_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel08

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel09_Tbl 
    ON View_UjobPesronel09_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel09

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel10_Tbl 
    ON View_UjobPesronel10_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel10

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel11_Tbl 
    ON View_UjobPesronel11_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel11

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS View_UjobPesronel12_Tbl 
    ON View_UjobPesronel12_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.UjobPesronel12

	 LEFT OUTER JOIN 
    dbo.View_UjobPesronel01_Tbl AS RegisterPesronel01_Tbl  
    ON RegisterPesronel01_Tbl.[UjobPesronel01ID] = DailyActivityEvidence01_Tbl.RegisterPesronel01


	LEFT OUTER JOIN
     --INNER JOIN 
    dbo.View_CategoriesGeneral_Tbl AS CatUnit
    ON CatUnit.CategoryGeneralId=DailyActivityEvidence01_Tbl.UnitID01  

	LEFT OUTER JOIN 
    dbo.Sortable01_Tbl AS Sortable01_Tbl 
    ON DailyActivityEvidence01_Tbl.Sortable01Id = Sortable01_Tbl.Sortable01Id
