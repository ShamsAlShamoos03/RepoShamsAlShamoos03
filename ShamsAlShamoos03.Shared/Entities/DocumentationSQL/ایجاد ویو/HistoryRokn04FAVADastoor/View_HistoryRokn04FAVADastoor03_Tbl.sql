...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryRokn04FAVADastoor01_Tbl])
)
...
FROM [dbo].[HistoryRokn04FAVADastoor01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryRokn04FAVADastoor01ID = dc.HistoryRokn04FAVADastoor01ID
