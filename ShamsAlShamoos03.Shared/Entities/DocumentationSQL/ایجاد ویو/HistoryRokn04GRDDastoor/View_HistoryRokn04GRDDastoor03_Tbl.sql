...
WITH EmployeeData AS (
    ...
    WHERE MelliCode IN (SELECT MelliCode FROM [HistoryRokn04GRDDastoor01_Tbl])
)
...
--top 1
	...
	LEFT(pc.[DocumentNO01],10)   AS Date01 ,
	  ...
	  [CatDateProperty01].HolidayStatusGRDID as HolidayStatusGRDID,
...
FROM [dbo].[HistoryRokn04GRDDastoor01_Tbl] pc


--INNER JOIN DateCalculations dc ON pc.HistoryRokn04GRDDastoor01ID = dc.HistoryRokn04GRDDastoor01ID
