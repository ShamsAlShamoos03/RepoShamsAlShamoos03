...
,DailyActivityEvidence01ID
 SELECT * FROM [IRIAAIsfahan04].[dbo].[View_DailyPlanEvidence02]     where [UitID01] ='35' 
 SELECT * FROM [IRIAAIsfahan04].[dbo].[View_DailyPlanEvidence02]     where DailyActivityEvidence01ID ='0cb251cd-128b-4e3e-a247-978b62332b34' */
...
FROM [IRIAAIsfahan04].[dbo].[DailyPlanEvidence01_Tbl] AS dp
