...
using System.ComponentModel.DataAnnotations.Schema;
    ...
    public class HistoryRokn04TRNDetailDastoor01
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
        [Key]
        //[StringLength(10, MinimumLength = 10, ErrorMessage = "HistoryRokn04TRNDetailDastoor01ID must be 8 characters")]
        public string? HistoryRokn04TRNDetailDastoor01ID  { get; set; }

        public string? HistoryRokn04TRNDastoor01ID { get; set; }
        [ForeignKey("HistoryRokn04TRNDastoor01ID")]
        public virtual HistoryRokn04TRNDastoor01 oo_HistoryRokn04TRNDastoor { get; set; }
