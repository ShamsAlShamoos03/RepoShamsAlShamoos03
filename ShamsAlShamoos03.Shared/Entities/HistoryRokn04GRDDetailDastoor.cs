...
public class HistoryRokn04GRDDetailDastoor01
{
    /// <summary>
    ///  تاریخ شمسی
    /// </summary>
    [Key]
    //[StringLength(10, MinimumLength = 10, ErrorMessage = "HistoryRokn04GRDDetailDastoor01ID must be 8 characters")]
    public string? HistoryRokn04GRDDetailDastoor01ID { get; set; }

    public string? HistoryRokn04GRDDastoor01ID { get; set; }
    [ForeignKey("HistoryRokn04GRDDastoor01ID")]
    public virtual HistoryRokn04GRDDastoor01 oo_HistoryRokn04GRDDastoor { get; set; }
    ...
    [ForeignKey("MelliCodeMain")]
    public virtual TblMaster oo_CrewDailyPesronelMain { get; set; }
