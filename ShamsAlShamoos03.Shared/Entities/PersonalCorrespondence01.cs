...
public class PersonalCorrespondence01 : BaseApprovalNavigationEntity
{
    /// <summary>
    ///  تاریخ شمسی
    /// </summary>
    [Key]
    //[StringLength(10, MinimumLength = 10, ErrorMessage = "PersonalCorrespondence01ID must be 8 characters")]
