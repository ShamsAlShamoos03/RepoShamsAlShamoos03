...
public class HistoryRokn04FAVADetailDastoor01
{
    /// <summary>
    ///  تاریخ شمسی
    /// </summary>
    [Key]
    //[StringLength(10, MinimumLength = 10, ErrorMessage = "HistoryRokn04FAVADetailDastoor01ID must be 8 characters")]
    public string? HistoryRokn04FAVADetailDastoor01ID { get; set; }

    public string? HistoryRokn04FAVADastoor01ID { get; set; }
    [ForeignKey("HistoryRokn04FAVADastoor01ID")]
    public virtual HistoryRokn04FAVADastoor01 oo_HistoryRokn04FAVADastoor { get; set; }
