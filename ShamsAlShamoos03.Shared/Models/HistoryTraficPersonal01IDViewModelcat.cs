...
namespace ShamsAlShamoos03.Shared.Models
{
    ...
    public class HistoryTraficPersonal01ViewModel_Update
    {
        ///// <summary>
        /////  تاریخ شمسی
        ///// </summary>
        ...
        //public string? DateDesAmar01HistoryTraficPersonal01ID { get; set; }
        //public string? DateDesAmar02HistoryTraficPersonal01ID { get; set; }
        //public int? DesAmar01HistoryTraficPersonal01ID { get; set; }

        //public string? DifDateDesAmar02DateDesAmar01Personal { get; set; }
        ///// <summary>
        ///// وضعیت آمار
        ///// </summary>
        //public string? strDesAmar01HistoryTraficPersonal01ID { get; set; }
...
//#endregion
    ...
    //    public string? Vartext06 { get; set; }
    //}
    public class Vw_NoDelayByMonth_MelliCodeModelcat
    {
        public string Month01 { get; set; }
        public string MelliCode { get; set; }
        public string Vartext02 { get; set; }
        public string NoDelayinMonth { get; set; }

    }
    public class HistoryTraficPersonal01ViewModelcat
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
