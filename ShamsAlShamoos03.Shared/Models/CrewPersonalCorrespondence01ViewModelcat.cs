...
{
    public class CrewPersonalCorrespondence01ViewModelcat
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
       public string CrewPersonalCorrespondence01ID { get; set; }
        ...
        public string? CountVacatiaonWitoutHoliday { get; set; }
         ...
         public string? DateDesAmar01CrewPersonalCorrespondence01ID { get; set; }
        public string? DateDesAmar02CrewPersonalCorrespondence01ID { get; set; }
        public int? DesAmar01CrewPersonalCorrespondence01ID { get; set; }

        public string? DifDateDesAmar02DateDesAmar01Personal { get; set; }
        /// <summary>
        /// وضعیت آمار
        /// </summary>
        public string? strDesAmar01CrewPersonalCorrespondence01ID { get; set; }
