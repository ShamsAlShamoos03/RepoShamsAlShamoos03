...
namespace ShamsAlShamoos03.Shared.Models
{
    ...
    public class HistoryRokn04GRDDetailDastoor01ViewModel_Update
    {
        ///// <summary>
        /////  تاریخ شمسی
        ///// </summary>
        public string HistoryRokn04GRDDetailDastoor01ID { get; set; }
        ...
        public DateTime? TimeAddOREditYagen01Publish { get; set; }
         

        public string UjobPesronel05FullNameFarmande01
        {
            get
            {
                return $"{UjobPesronel05strDarajee} {UjobPesronel05strFirstName} {UjobPesronel05strLastName}";
            }
        }
        public string UjobPesronel07FullNameFarmande01
        {
            get
            {
                return $"{UjobPesronel07strDarajee} {UjobPesronel07strFirstName} {UjobPesronel07strLastName}  {DateRegDastoor}";
            }
        }
        ...
        public string Whostatus321
        {
            get
            {
                ...
                //if (StatusConfirmation01 == 321)
                //    names.Add($"{UjobPesronel01strDarajee} {UjobPesronel01strFirstName} {UjobPesronel01strLastName}");
        ...
        public string? strUitID01Main { get; set; }
        public int? UnitID01Main { get; set; }
        ...
        //public string? DateDesAmar01HistoryRokn04GRDDetailDastoor01ID { get; set; }
        //public string? DateDesAmar02HistoryRokn04GRDDetailDastoor01ID { get; set; }
        //public int? DesAmar01HistoryRokn04GRDDetailDastoor01ID { get; set; }

        //public string? DifDateDesAmar02DateDesAmar01Personal { get; set; }
        ///// <summary>
        ///// وضعیت آمار
        ///// </summary>
        //public string? strDesAmar01HistoryRokn04GRDDetailDastoor01ID { get; set; }
        ...
        ///  درجه نام و نشان ش کا کد ملی
        /// </summary>
        public string? MelliCodeMain { get; set; }
        ...
        /// </summary>
        [Display(Name = "شماره کارگزینی")]
        public string? EMP_NUMMain { get; set; }
        /// <summary>
        /// نام
        /// </summary>
        [Display(Name = "نام")]
        public string? FST_NAMMain { get; set; }
        /// <summary>
        /// نام خانوادگی
        /// </summary>
        [Display(Name = "نام خانوادگی")]
        public string? LST_NAMMain { get; set; }
        ...
        public string? DRJ_NAMMain { get; set; }
        //public string? RST_NAM { get; set; }

        public string? DUS_CODMain { get; set; }
        ...
        //public string? persianWeekDate01 { get; set; }
        //public string? strDateCategory01 { get; set; }
        public string? HolidayStatusGRD { get; set; }

        public string? HolidayStatusGRDID { get; set; }
    ...
    public class HistoryRokn04GRDDetailDastoor01ViewModelcat
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
        ...
        public string? subVartext01 { get; set; }
        public string? subVartext02 { get; set; }
        public string? subVartext03 { get; set; }
        public string? subVartext04 { get; set; }
        public string? subVartext05 { get; set; }
        public string? subVartext06 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext07 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext08 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext09 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext10 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext11 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext12 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext13 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext14 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext15 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext16 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext17 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext18 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext19 { get; set; }

        /// <summary>
        //متن نامه
        /// </summary>
        public string? subVartext20 { get; set; }
