...
namespace ShamsAlShamoos03.Shared.Models
{
    ...
    public class FlightActivityEvidence01IDViewModelcat
    {

        public string FlightActivityEvidence01ID { get; set; }
    }
    public class FlightActivityEvidence01ViewModelcat
    {
        /// <summary>
        ///01 کد ملی ثبت کننده
        /// </summary>
        ...
        public string FlightActivityEvidence01ID { get; set; }
        public string FlightActivityEvidence01IDstr { get; set; }

        public string FlightActivityEvidence01IDstr3 { get; set; }
        public string FlightActivityEvidence01IDstr4 { get; set; }
        public string FlightActivityEvidence01IDstr5 { get; set; }
        public string FlightActivityEvidence01IDstr6 { get; set; }
        ...
        ///// </summary>
        //public string? FromDateFlightActivityEvidence01TitleRamainDay01 { get; set; }
        ///// <summary>
        /////  روز باقیمانده تا تاریخ خاتمه
        ///// </summary>
        //public string? ToDateFlightActivityEvidence01TitleRamainDay01 { get; set; }
        ...
        public string? StatusFlightActivityEvidence01str { get; set; }
