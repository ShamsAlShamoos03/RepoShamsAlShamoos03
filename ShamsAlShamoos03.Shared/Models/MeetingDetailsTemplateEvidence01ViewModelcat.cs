...
namespace ShamsAlShamoos03.Shared.Models
{
    ...
    public class MeetingDetailsTemplateEvidence01ViewModelcat
    {
        /// <summary>
        ///01 کد ملی ثبت کننده
        /// </summary>
        ...
        public string? MeetingConetntEvidence01IDNOTAMCHECKETitle02 { get; set; }
        ...
        public string MeetingDetailsTemplateEvidence01IDstr { get; set; }

        public string MeetingDetailsTemplateEvidence01IDstr3 { get; set; }
        public string MeetingDetailsTemplateEvidence01IDstr4 { get; set; }
        public string MeetingDetailsTemplateEvidence01IDstr5 { get; set; }
        public string MeetingDetailsTemplateEvidence01IDstr6 { get; set; }
        ...
        public string? TypeMeetingstr { get; set; }


        public int? TitleMeeting { get; set; }
        public string? TitleMeetingstr { get; set; }

        public int? MeetingConetnt { get; set; }
        public string? MeetingConetntstr { get; set; }


        public int? PlaceMeeting { get; set; }
        public string? PlaceMeetingstr { get; set; }
        ...
        ///// </summary>
        //public string? FromDateMeetingDetailsTemplateEvidence01TitleRamainDay01 { get; set; }
        ///// <summary>
        /////  روز باقیمانده تا تاریخ خاتمه
        ///// </summary>
        //public string? ToDateMeetingDetailsTemplateEvidence01TitleRamainDay01 { get; set; }
        ...
        public string? StatusMeetingDetailsTemplateEvidence01str { get; set; }
