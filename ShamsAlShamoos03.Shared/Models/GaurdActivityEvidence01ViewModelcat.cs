...
namespace ShamsAlShamoos03.Shared.Models
{
    ...
    public class GaurdActivityEvidence01IDViewModelcat
    {

        public string GaurdActivityEvidence01ID { get; set; }
    }
    public class GaurdActivityEvidence01ViewModelcat
    {
        /// <summary>
        ///01 کد ملی ثبت کننده
        /// </summary>
        ...
        public string GaurdActivityEvidence01ID { get; set; }
        public string GaurdActivityEvidence01IDstr { get; set; }

        public string GaurdActivityEvidence01IDstr3 { get; set; }
        public string GaurdActivityEvidence01IDstr4 { get; set; }
        public string GaurdActivityEvidence01IDstr5 { get; set; }
        public string GaurdActivityEvidence01IDstr6 { get; set; }
        ...
        ///// </summary>
        //public string? FromDateGaurdActivityEvidence01TitleRamainDay01 { get; set; }
        ///// <summary>
        /////  روز باقیمانده تا تاریخ خاتمه
        ///// </summary>
        //public string? ToDateGaurdActivityEvidence01TitleRamainDay01 { get; set; }
        ...
        public string? StatusGaurdActivityEvidence01str { get; set; }
