...
{
    public class HistoryRokn04ArrestDetailDastoor01ViewModel_Update
    {
        ///// <summary>
        /////  تاریخ شمسی
        ///// </summary>
        public string HistoryRokn04ArrestDetailDastoor01ID { get; set; }
        ...
        //public string? DateDesAmar01HistoryRokn04ArrestDetailDastoor01ID { get; set; }
        //public string? DateDesAmar02HistoryRokn04ArrestDetailDastoor01ID { get; set; }
        //public int? DesAmar01HistoryRokn04ArrestDetailDastoor01ID { get; set; }

        //public string? DifDateDesAmar02DateDesAmar01Personal { get; set; }
        ///// <summary>
        ///// وضعیت آمار
        ///// </summary>
        //public string? strDesAmar01HistoryRokn04ArrestDetailDastoor01ID { get; set; }
        ...
        //public string? persianWeekDate01 { get; set; }
        //public string? strDateCategory01 { get; set; }
        public string? HolidayStatusArrest { get; set; }

        public string? HolidayStatusArrestID { get; set; }
    ...
    public class HistoryRokn04ArrestDetailDastoor01ViewModelcat
    {
        /// <summary>
        ///  تاریخ شمسی
        /// </summary>
        public string HistoryRokn04ArrestDetailDastoor01ID { get; set; }
        public string HistoryRokn04ArrestDastoor01ID { get; set; }
